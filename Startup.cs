...
using CustomerManagement.app.repositories.Implementation;
using CustomerManagement.app.services;
using CustomerManagement.app.core.repositories;
using CustomerManagement.app.core.repositories.Implementations;
using CustomerManagement.app.core.services;
using CustomerManagement.app.core.middlewares;
...
namespace CustomerManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IAppExceptionRepository, AppExceptionRepository>();
            services.AddTransient<LogService>();
            services.AddTransient<AppExceptionService>();
        }
